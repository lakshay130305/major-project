          ...
          <form onSubmit={requestReset} className="space-y-4">
            <div>
              ...
              <input id="fp-email" value={email} onChange={(e) => setEmail(e.target.value)}
                className="mt-1 w-full border border-slate-300 dark:border-slate-600 dark:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 rounded-lg px-3 py-2 focus:ring-2 focus:ring-sky-500 outline-none"
                type="email" required />
            </div>
